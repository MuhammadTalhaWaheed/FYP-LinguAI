...
const B1_L2_Chapter3Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Expressing Preferences and Opinions        </Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "I prefer staying in rather than going out. In my opinion, home-cooked food is healthier."
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("I prefer staying in rather than going out. In my opinion, home-cooked food is healthier.")}
        >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.phraseContainer}>
          ...
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I prefer....")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>In my opinion...        </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("In my opinion...")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I think / I believe...</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I think / I believe...")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.section}>
        ...
        <Text style={styles.text}>Do you prefer tea or coffee?</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Do you prefer tea or coffee?")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('B1_l2_chapter4')}>
...
export default B1_L2_Chapter3Screen;
