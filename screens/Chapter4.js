  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Saying Goodbye</Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "It was nice talking to you. Goodbye! Have a great day!"
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("It was nice talking to you. Goodbye! Have a great day!")}
        >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>Goodbye, Bye, See you later</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("Goodbye, Bye, See you later.")}> 
        ...
        <View style={styles.phraseContainer}>
          ...
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("Have a great day!")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.section}>
        ...
        <Text style={styles.text}>Ok, I am leaving now</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Ok, I am leaving now")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('Chapter5')}>
