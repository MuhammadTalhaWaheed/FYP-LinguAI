...
const B1_L3_Chapter1Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Making Polite Requests        </Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "Could you please send me the report by tomorrow? I’d really appreciate it."
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Could you please send me the report by tomorrow? I’d really appreciate it.")}
        >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>Could you please...?        </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("Could you please...?")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>Would you mind...?.</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("Would you mind...?")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I’d appreciate it if...        </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I’d appreciate it if...")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>Tell about your day</Text>
        <Text style={styles.text}>You need a colleague to review your document. What do you say?</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("You need a colleague to review your document. What do you say?")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('B1_l3_chapter2')}>
...
export default B1_L3_Chapter1Screen;
