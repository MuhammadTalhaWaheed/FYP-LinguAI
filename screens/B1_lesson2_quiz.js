...
const B1_Lesson2_quiz = ({ navigation }) => {
  ...
  const submitAssessment = async () => {
    ...
    if (fillBlankAnswer.trim().toLowerCase() === "am") score += 1;
    ...
    const auth = getAuth();
        ...
        const userScoreRef = doc(db, `users/${user.uid}/scores_L2`, 'lesson_2');
        ...
        try {
          ...
          if (score === 3) {
            ...
            navigation.navigate('B1_l3_chapter1');
          } else {
          ...
          if (score >= 2) {
            const newAchievement = {
              title: "Intermediate Lesson 2 Passed",
              description: "You successfully passed Intermediate Lesson 2!",
              date: new Date().toISOString(),
              badgeUrl: '../assets/logo.png',
            };
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.prompt}>“Would you like to go for dinner? refers to ” →</Text>
        ...
        <View style={styles.dropdownContainer}>
          ...
          >
            ...
            <Picker.Item label="Making a suggestion" value="wake" />
            <Picker.Item label="Making a confession" value="goodbye" />
            <Picker.Item label="None of the above" value="sleep" />
          </Picker>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.prompt}>“I ___ going to the movies tonight.”</Text>
        <TextInput
          style={styles.input}
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.prompt}>“Would you like to go hiking tomorrow?”</Text>
        <TouchableOpacity
...
export default B1_Lesson2_quiz;