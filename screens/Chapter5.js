  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "Hi! My name is Emily. I’m from Australia. It’s nice to meet you. Where are you from? What do you like to do in your free time?"
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Hi! My name is Emily. I’m from Australia. It’s nice to meet you. Where are you from? What do you like to do in your free time?")}
        >
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>Hi! My name is Alex. What’s your name?</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Hi! My name is Alex. What’s your name?")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
          <Text style={styles.audioButtonText}>Play Audio</Text>
        </TouchableOpacity>
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
        ...
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Where are you from?")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
          <Text style={styles.audioButtonText}>Play Audio</Text>
        </TouchableOpacity>
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('lesson1_quiz')}>
