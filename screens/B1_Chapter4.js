...
const B1_Chapter4Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Shopping and Transactions</Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "How much does this cost? Do you have it in another color? I’ll take it."
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("How much does this cost? Do you have it in another color? I’ll take it.")}
        >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>How much is this?</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("How much is this?")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>Do you have...?</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("Do you have...?")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I’ll take it / I’m just looking</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I’ll take it / I’m just looking")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.section}>
        ...
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Can I help you?")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('B1_Chapter5')}>
...
export default B1_Chapter4Screen;
