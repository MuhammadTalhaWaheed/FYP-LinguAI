  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Asking Simple Questions</Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => playAudio("Where are you from? How are you? What do you do?")}
        >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.phraseContainer}>
          ...
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("Where are you from?")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>How are you?</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("How are you?")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>What do you do?</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("What do you do?")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      </View>
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('Chapter3')}>
