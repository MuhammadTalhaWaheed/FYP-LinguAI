...
const B1_Chapter3Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Making a Complaint or Request</Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "Excuse me, my food is cold. Could you please warm it up? I’d appreciate it."
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Excuse me, my food is cold. Could you please warm it up? I’d appreciate it.")}
        >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>My [item] is not working.</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("My [item] is not working.")}> 
        ...
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I’d appreciate it.</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I’d appreciate it.")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.section}>
        ...
        <Text style={styles.text}>Your hotel room’s air conditioner isn’t working. What do you say?</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Your hotel room’s air conditioner isn’t working. What do you say?")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('B1_Chapter4')}>
...
export default B1_Chapter3Screen;
