...
const B1_Lesson3_quiz = ({ navigation }) => {
  ...
  const submitAssessment = async () => {
    ...
    if (fillBlankAnswer.trim().toLowerCase() === "send") score += 1;
  ...
  const auth = getAuth();
          ...
          const userScoreRef = doc(db, `users/${user.uid}/scores_L2`, 'lesson_3');
          ...
          try {
            ...
            if (score === 3) {
              ...
              navigation.navigate('lesson_award_inter_to_adv');
            } else {
            ...
            if (score >= 2) {
              const newAchievement = {
                title: "Intermediate Lesson 3 Passed",
                description: "You successfully passed Intermediate Lesson 3!",
                date: new Date().toISOString(),
                badgeUrl: '../assets/logo.png',
              };
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.prompt}>'Best regards' refers to  →</Text>
        ...
        <View style={styles.dropdownContainer}>
          ...
          >
            ...
            <Picker.Item label="Scolding" value="night" />
            <Picker.Item label="Formal Email" value="sun" />
            <Picker.Item label="Happiness" value="sleep" />
          </Picker>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.prompt}>“Could you please ___ me the file?”</Text>
        <TextInput
          style={styles.input}
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.prompt}>“Your teammate gave you feedback on a presentation. Respond professionally.”</Text>
        <TouchableOpacity
...
<View style={styles.section}>
  ...
  <Text style={styles.recognizedText}>{recognizedText || "No text recognized yet"}</Text>
      ...
      {/* Multiple Choice */}
      <View style={styles.section}>
        <Text style={styles.question}>What’s a professional way to disagree?</Text>
        <TouchableOpacity
          style={[styles.option, multipleChoiceAnswer === 'A' && styles.selectedOption]}
          onPress={() => setMultipleChoiceAnswer('A')}
        >
          <Text style={styles.optionText}>A) You’re wrong!</Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={styles.optionText}>C)  I don’t think so</Text>
        </TouchableOpacity>
      </View>
...
export default B1_Lesson3_quiz;