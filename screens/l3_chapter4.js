...
const l3_Chapter4Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Talking About the Weather</Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "It’s sunny today. Do you like sunny weather? I love it!"
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("It’s sunny today. Do you like sunny weather? I love it!")}
        >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>It’s sunny/rainy/cloudy.         </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("It’s sunny/rainy/cloudy...")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>Do you like this weather?          </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("Do you like this weather?")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I love it/I don’t like it.
          </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I love it/I don’t like it.")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.section}>
        ...
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("What’s the weather like today?")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('l3_chapter5')}>
...
export default l3_Chapter4Screen;
