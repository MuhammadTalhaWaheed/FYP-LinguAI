...
const B1_L2_Chapter2Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Accepting or Declining Plans       </Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "Sounds great, I’d love to! / I’m sorry, I can’t make it today. Maybe another time?"
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Sounds great, I’d love to! / I’m sorry, I can’t make it today. Maybe another time?")}
        >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>That sounds great!</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("That sounds great!")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I’d love to.          </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I’d love to")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I’m sorry, I can’t.          .</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I’m sorry, I can’t.")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.section}>
        ...
        <Text style={styles.text}>Your friend invites you to a picnic. Respond.</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Your friend invites you to a picnic. Respond.")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('B1_l2_chapter3')}>
...
export default B1_L2_Chapter2Screen;
