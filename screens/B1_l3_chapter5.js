...
const B1_L3_Chapter5Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Handling Workplace Conflict or Feedback</Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "I understand your concern. Let’s find a solution together. I’ll try to improve next time."
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("I understand your concern. Let’s find a solution together. I’ll try to improve next time.")}
        >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I understand your concern       </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I understand your concern")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>Let’s find a solution        </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("Let’s find a solution")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I appreciate your feedback
          </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I appreciate your feedback")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.section}>
        ...
        <Text style={styles.text}>Your colleague says your report was late. How do you respond?”</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Your colleague says your report was late. How do you respond?")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('B1_lesson3_quiz')}>
...
export default B1_L3_Chapter5Screen;
