...
const B1_L3_Chapter2Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Writing Formal Emails      </Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "Dear Mr. Ahmed,
 I hope this email finds you well. I’m writing to request a copy of the updated schedule.
 Best regards,
 Ali"
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Dear Mr. Ahmed,I hope this email finds you well. I’m writing to request a copy of the updated schedule.Best regards,Ali")}
        >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>Dear [Name],
          </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("Dear [Name],")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I’m writing to...</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I’m writing to...")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>Best regards / Sincerely        </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("Best regards / Sincerely")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.section}>
        ...
        <Text style={styles.text}>Tell the opening and closing lines of an email to your manager.</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Tell the opening and closing lines of an email to your manager.")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('B1_l3_chapter3')}>
...
export default B1_L3_Chapter2Screen;
