...
const B1_L3_Chapter3Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Participating in Meetings       </Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "“I agree with your point. However, I think we should consider another option."
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("I agree with your point. However, I think we should consider another option.")}
        >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I agree / I see your point          </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I agree / I see your point")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>However, I think...        </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("However, I think...")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>May I add something?       </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("May I add something?")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.section}>
        ...
        <Text style={styles.text}>What do you think about the proposal?</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("What do you think about the proposal?”.")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('B1_l3_chapter4')}>
...
export default B1_L3_Chapter3Screen;
