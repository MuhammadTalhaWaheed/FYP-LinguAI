  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Starting a Conversation        </Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "Hi, how are you? It’s a nice day today. What are you up to?"
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Hi, how are you? It’s a nice day today. What are you up to?")}
        >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.phraseContainer}>
          ...
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("Hi, how are you?")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>It’s a nice day.</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("It’s a nice day.")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>What are you up to?          </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("What are you up to?")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.section}>
        ...
        <Text style={styles.text}>Start a conversation with someone you just met.</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Start a conversation with someone you just met.")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
...
export default L3_Chapter1Screen;
