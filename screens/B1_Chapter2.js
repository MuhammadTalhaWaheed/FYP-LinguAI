...
const B1_Chapter2Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Navigating Public Places</Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "Go straight and take the second left. The bank is next to the supermarket.”
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Go straight and take the second left. The bank is next to the supermarket.")}
        >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>Go straight / turn left / turn right
          </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("Go straight / turn left / turn right")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>You’ll see it on your left/right</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("You’ll see it on your left/right")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>It’s near / next to / opposite</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("It’s near / next to / opposite")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.section}>
        ...
        <Text style={styles.text}>Ask how to get to the library.</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Ask how to get to the library.")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('B1_Chapter3')}>
...
export default B1_Chapter2Screen;
