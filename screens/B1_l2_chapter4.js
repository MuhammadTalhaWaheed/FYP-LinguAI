...
const B1_L2_Chapter4Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Agreeing and Disagreeing Politely</Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "I see your point, but I think we should wait. / I completely agree with you."
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("I see your point, but I think we should wait. / I completely agree with you.")}
        >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I agree / I completely agree          </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I agree / I completely agree")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I see your point, but...          </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I see your point, but...")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I’m not sure I agree</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I’m not sure I agree")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.section}>
        ...
        <Text style={styles.text}>A friend says: ‘Movies are better than books.’ What do you say?</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("A friend says: ‘Movies are better than books.’ What do you say?")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('B1_l2_chapter5')}>
...
export default B1_L2_Chapter4Screen;
