...
const L3_Chapter2Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Asking About Preferences       </Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "Do you like coffee or tea? I prefer coffee. What about you?"
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Do you like coffee or tea? I prefer coffee. What about you?")}
        >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>Do you like...?
          </Text>
        ...
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>What about you?          </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("What about you?")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.section}>
        ...
        <Text style={styles.text}>Do you like movies or books?</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Do you like movies or books?")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
...
export default L3_Chapter2Screen;
