...
const B1_L2_Chapter5Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Talking About Future Plans</Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "I’m going to visit my cousins this weekend. I’ll also study for my exam."
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("I’m going to visit my cousins this weekend. I’ll also study for my exam.")}
        >
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>What are your plans for the weekend?</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("What are your plans for the weekend?")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
          <Text style={styles.audioButtonText}>Play Audio</Text>
        </TouchableOpacity>
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('B1_lesson2_quiz')}>
...
export default B1_L2_Chapter5Screen;
