...
const B1_L2_Chapter1Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Making Suggestions and Invitations</Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "Would you like to go for coffee this evening? We could also watch a movie after that."
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Would you like to go for coffee this evening? We could also watch a movie after that.")}
        >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>Would you like to...?</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("Would you like to...?")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>Why don’t we...?</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("Why don’t we...?")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>We could...</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("We could...")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>Invite a friend to go out tonight.</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Invite a friend to go out tonight.")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('B1_l2_chapter2')}>
...
export default B1_L2_Chapter1Screen;
