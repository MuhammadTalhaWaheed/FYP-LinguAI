...
const l2_Chapter4Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Talking About Weekends</Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "On Saturdays, I clean my room. On Sundays, I go to the park. I also visit my friends."
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("On Saturdays, I clean my room. On Sundays, I go to the park. I also visit my friends.")}
        >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>On Saturdays/Sundays...          </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("On Saturdays/Sundays...")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I go to the park.          </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I go to the park.")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I clean my room</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I clean my room")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      </View>
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('l2_chapter5')}>
...
export default l2_Chapter4Screen;
