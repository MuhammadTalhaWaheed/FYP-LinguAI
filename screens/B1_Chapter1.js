...
const B1_Chapter1Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Asking for Help</Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "Excuse me, can you help me? I’m looking for the train station. I think I’m lost"
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Excuse me, can you help me? I’m looking for the train station. I think I’m lost")}
        >
      ...
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>Learn Key Phrases</Text>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>Excuse me</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("Excuse me")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>Can you help me?</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("Can you help me?")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I’m looking for...</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I’m looking for...")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I think I’m lost</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I think I’m lost")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.section}>
        ...
        <Text style={styles.text}>You’re lost in a city. What do you say to someone nearby?</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("You’re lost in a city. What do you say to someone nearby?")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('B1_Chapter2')}>
...
export default B1_Chapter1Screen;
