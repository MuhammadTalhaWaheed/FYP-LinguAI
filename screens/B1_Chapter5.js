...
const B1_Chapter5Screen = ({ navigation }) => {
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "Excuse me, I’m looking for the post office. Can you help me? Oh, and could you tell me where I can buy stamps too?"
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Excuse me, I’m looking for the post office. Can you help me? Oh, and could you tell me where I can buy stamps too?")}
        >
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
          ...
          <Text style={styles.text}>Go straight and turn right. It’s next to the grocery store.</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Go straight and turn right. It’s next to the grocery store.")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
          <Text style={styles.audioButtonText}>Play Audio</Text>
        </TouchableOpacity>
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
          ...
          <Text style={styles.label}>Transcription:</Text>
          <Text style={styles.text}>{transcription}</Text>
          <Text style={styles.text}>It was nice talking to you. Goodbye!</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("It was nice talking to you. Goodbye!")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('B1_lesson1_quiz')}>
        <Text style={styles.nextButtonText}>Go to Lesson 1 Assessment →</Text>
      </TouchableOpacity>
    </ScrollView>
  );
};
...
export default B1_Chapter5Screen;
