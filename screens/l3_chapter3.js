...
const L3_Chapter3Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Giving and Accepting Compliments        </Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "You have a great smile! Thank you, that’s very kind of you."
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("You have a great smile! Thank you, that’s very kind of you.")}
        >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.phraseContainer}>
          ...
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("You look great")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I love your...          </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I love your..")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>Thank you! That’s kind of you.          </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("Thank you! That’s kind of you.")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.section}>
        ...
        <Text style={styles.text}>Give a compliment to your friend.</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("Give a compliment to your friend.")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('l3_chapter4')}>
...
export default L3_Chapter3Screen;
