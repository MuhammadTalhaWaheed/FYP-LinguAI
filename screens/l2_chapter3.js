...
const L2_Chapter3Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Evening and Night Activities        </Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "In the evening, I watch TV. I eat dinner with my family. I go to bed at 10 o’clock."
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("In the evening, I watch TV. I eat dinner with my family. I go to bed at 10 o’clock.")}
        >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>In the evening...          </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("In the evening...")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I eat dinner.          </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I eat dinner.")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I go to bed at..</Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I go to bed at..")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.section}>
        ...
        <Text style={styles.text}>What do you do in the evening?</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("What do you do in the evening?")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('L2_chapter4')}>
...
export default L2_Chapter3Screen;
