...
const B1_L3_Chapter4Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Describing Job Roles and Work Tasks</Text>
      </View>
      ...
      <Modal visible={showModal} transparent={true} animationType="slide">
       ...
       <Text style={styles.sectionTitle}>Listen</Text>
        <Text style={styles.text}>
          "I work as a software engineer. I develop applications and attend daily team meetings."
        </Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("I work as a software engineer. I develop applications and attend daily team meetings.")}
        >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I work as...        </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I work as...")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>My responsibilities include...          </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("My responsibilities include...")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.phraseContainer}>
          <Text style={styles.text}>I’m responsible for...
          </Text>
          <TouchableOpacity style={styles.audioButtonSmall} onPress={() => playAudio("I’m responsible for...")}> 
            <MaterialCommunityIcons name="volume-high" size={20} color="white" />
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.section}>
        ...
        <Text style={styles.text}>What is your job, and what do you do?</Text>
        <TouchableOpacity
          style={styles.audioButton}
          onPress={() => playAudio("What is your job, and what do you do?")}
        >
          <MaterialCommunityIcons name="volume-high" size={24} color="white" />
...
>
  <Text style={styles.recordButtonText}>
    {isRecording ? 'Stop Recording' : 'Start Recording'}
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('B1_l3_chapter5')}>
...
export default B1_L3_Chapter4Screen;
